...
import { signupStart, signupSuccess, signupFailure, setInitialized } from '../store/authSlice';
...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(signupFailure(err.response?.data?.message || 'Signup failed. Please try again.'));
    }
  };
