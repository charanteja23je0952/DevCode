...
- Backend: persist the requested task status changes through the existing reorder endpoint,
...
- Frontend: update the frontend state after the reorder request succeeds,
